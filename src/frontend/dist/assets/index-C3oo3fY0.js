      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center justify-center w-8 h-8 rounded-full bg-primary text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-4 h-4" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-semibold text-lg text-foreground", children: [
                "Fresh Valley ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Produce" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed max-w-xs", children: "Premium B2B vegetable sourcing and logistics for retailers and restaurants across the region." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm uppercase tracking-widest text-foreground mb-4", children: "Quick Links" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm uppercase tracking-widest text-foreground mb-4", children: "Contact" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2.5 text-sm text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 mt-0.5 shrink-0 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "123 Harvest Road, Springfield" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2.5 text-sm text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 shrink-0 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "(555) 555-0178" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2.5 text-sm text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 shrink-0 text-primary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "info@freshvalleyproduce.com" })
              ] })
            ] })
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "© ",
            year,
            " Fresh Valley Produce. All rights reserved."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-smooth ${scrolled ? "bg-card border-b border-border shadow-subtle" : "bg-card/95 border-b border-border/60"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center justify-center w-8 h-8 rounded-full bg-primary text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-4 h-4" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-semibold text-lg text-foreground tracking-tight", children: [
                  "Fresh Valley ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Produce" })
                ] })
              ]
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-card border-t border-border px-4 pt-2 pb-4 shadow-elevated", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col gap-1", "aria-label": "Mobile navigation", children: [
          navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
...
const products = [
  {
    ...
    description: "Left on the vine until peak ripeness for full flavour depth. Ideal for restaurant sauces and retail premium lines. Rich umami flavour, smooth skin, consistent sizing.",
    season: "Summer",
  ...
  },
  {
    ...
    description: "Dense, tightly-packed heads with refreshing crunch. Long shelf life and excellent moisture retention make it a staple for salad bars and sandwich counters.",
    season: "Spring",
  ...
  },
  {
    ...
    description: "Multi-variety heritage carrots — purple, yellow, and orange — grown slowly for superior sweetness and crunch. A showstopper in restaurant presentations.",
    season: "Autumn",
    availability: "In Season",
  ...
  },
  {
    ...
    description: "Vibrant red, yellow, and green peppers in a mixed case. Thick walls, sweet flesh, ideal for stir fries, stuffed pepper dishes, and retail display.",
    season: "Summer",
    availability: "In Season",
    category: "Nightshades",
    sourcing: "Locally sourced — Sunfield Glasshouses, 25 km",
  ...
  },
  {
    ...
    description: "Long-stemmed broccoli with tender florets that need minimal prep. A premium option for restaurant menus and upscale retail. Sweet, nutty flavour profile.",
    season: "Spring",
    availability: "Available",
    category: "Brassicas",
  ...
  },
  {
    id: "baby-spinach",
    name: "Baby Spinach",
    description: "Young, tender spinach leaves harvested at their peak. Ready-to-use for salads, smoothies, and cooked applications. Triple-washed and pre-cooled for freshness.",
    season: "Year-Round",
    availability: "Available",
    category: "Leafy Greens",
  ...
  },
  {
    id: "brown-onions",
    name: "Brown Onions",
    description: "Year-round staple with tight outer skins and consistent sizing. Ideal for bulk catering and retail bagged lines. Classic pungent flavour, long storage life.",
    season: "Year-Round",
    availability: "Available",
    category: "Alliums",
  ...
  },
  {
    ...
    description: "The gold standard for chips and roasties. Consistently floury texture, pale gold skin, high dry matter. Available in retail 2.5 kg bags or 25 kg catering sacks.",
    season: "Year-Round",
    availability: "Available",
    category: "Root Vegetables",
    sourcing: "Regional network — East County Growers",
  ...
  },
  {
    ...
    description: "Outdoor-grown ridge cucumbers with firm texture and subtle earthy flavour. Slightly shorter than glasshouse varieties with pleasingly textured skin.",
    season: "Summer",
  ...
  },
  {
    id: "courgettes",
    name: "Courgettes",
    description: "Mid-size courgettes harvested before skin hardens. Uniform shape for easy kitchen prep and attractive retail display. Excellent versatility across cuisines.",
    season: "Summer",
    availability: "Limited",
    category: "Gourds",
    sourcing: "Locally sourced — Sunfield Glasshouses, 25 km",
  ...
  },
  {
    id: "savoy-cabbage",
    name: "Savoy Cabbage",
    description: "Deeply crinkled, vibrant green heads with sweet, mild flavour. Superb in winter soups, stir fries, and braised preparations. Excellent frost resistance.",
    season: "Winter",
  ...
  },
  {
    id: "wet-garlic",
    name: "Wet Garlic",
    description: "Freshly harvested garlic with moist, aromatic bulbs and mild flavour. A seasonal premium ingredient prized by chefs. Available in bulb bunches or loose.",
    season: "Spring",
    availability: "Pre-Order",
    category: "Alliums",
    sourcing: "Locally sourced — Riverdale Farms, 40 km",
  ...
  },
  {
    id: "organic-kale",
    name: "Organic Kale",
    description: "Certified organic curly kale, harvested young for tenderness. Consistent leaf size suits retail pre-pack. High iron and vitamin C — popular with health-focused retailers.",
    season: "Year-Round",
    availability: "Available",
    category: "Leafy Greens",
    sourcing: "Certified organic — Greenhill Organics",
  ...
  },
  {
    id: "sweet-potatoes",
    name: "Sweet Potatoes",
    description: "Orange-flesh sweet potatoes with high natural sugar content. Popular in restaurant menus and meal kits. Consistent sizing for retail bags and portion control.",
    season: "Autumn",
    availability: "In Season",
    category: "Root Vegetables",
    sourcing: "Locally sourced — Moorland Farm, 60 km",
...
const services = [
  {
    icon: Package,
    title: "Bulk Ordering",
    description: "Flexible case sizes and pallet quantities tailored for restaurants, retailers, and caterers. No over-complicated minimum order schedules — just straightforward bulk purchasing at competitive rates."
  },
  {
    icon: Truck,
    title: "Delivery Logistics",
    description: "Temperature-controlled fleet covering the tri-state region. Scheduled weekly runs and bespoke drops. Track your delivery in real time with our driver notification system."
  },
  {
    icon: Leaf,
    title: "Custom Packing",
    description: "Retail-ready packing, branded bags, and portioned catering trays. We accommodate private-label requirements and custom pack weights for high-volume accounts."
  },
  {
    icon: ShieldCheck,
    title: "Quality Guarantee",
    description: "Every consignment inspected and graded before dispatch. Consistent specification, accurate weights, and complete traceability documentation from farm to door."
  },
  {
    icon: DollarSign,
    title: "Volume Pricing Tiers",
    description: "Transparent tiered pricing that rewards loyalty and volume. Entry tier from $500/week, mid-volume from $1,500/week, and enterprise accounts negotiate direct terms with our sales team."
  }
];
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-foreground/55", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                ...
                children: "B2B Vegetable Wholesale"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-5xl sm:text-6xl lg:text-7xl font-bold text-primary-foreground leading-tight text-balance mb-6", children: "Fresh Valley Produce: Premium Wholesale Vegetables" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-primary-foreground/85 font-body leading-relaxed mb-8 max-w-xl", children: "Supplying the tri-state region's finest retailers and restaurants with consistently graded, farm-fresh produce since 1999. Trade accounts welcome — minimum orders to suit your operation." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  type: "button",
                  size: "lg",
                  onClick: () => handleScroll2("#products"),
                  className: "font-body",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-primary", "aria-label": "Key statistics", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-6", children: stats.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-3xl font-bold text-primary-foreground", children: s.value }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary-foreground/70 font-body mt-1", children: s.label })
    ] }, s.label)) }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-14 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl font-bold text-foreground mb-5 text-balance", children: "Growing partnerships since 1999" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-4", children: "Fresh Valley Produce started as a family operation supplying local greengrocers in Springfield. Over 25 years we've grown into the tri-state region's most trusted wholesale vegetable supplier — but our approach hasn't changed: honest pricing, real provenance, and produce that speaks for itself." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-6", children: "We work directly with farms to eliminate unnecessary middlemen, meaning you get better quality at competitive prices. Our dedicated logistics fleet ensures produce moves from field to your business with minimal delay and zero cold-chain compromise." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: [
              ...
              "li",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-4 h-4 mt-0.5 text-accent shrink-0" }),
          ...
          ].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-subtle border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-3xl font-bold text-primary mb-1", children: item.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body uppercase tracking-wider", children: item.label })
          ] }) }, item.label)) })
        ] }) })
      }
    ),
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body uppercase tracking-widest text-primary font-semibold mb-3", children: "Seasonal Catalogue" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl font-bold text-foreground mb-4 text-balance", children: "Our Produce" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "Sourced from trusted regional farms. Availability changes with the seasons — talk to us about standing orders and advance booking." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 mb-8 items-start sm:items-center", children: [
              ...
              "div",
              {
                ...
                children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: `px-3 py-1.5 text-xs font-body font-medium rounded-full border transition-smooth ${activeCategory === cat ? "bg-primary text-primary-foreground border-primary" : "bg-card text-muted-foreground border-border hover:border-primary/50 hover:text-foreground"}`,
          ...
          filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body", children: "No produce matched your search. Try a different term." })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: filtered.map((product, i) => {
                var _a3;
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Card,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-3", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            className: `shrink-0 text-[11px] font-body font-medium px-2 py-0.5 rounded-full border ${availabilityColor[product.availability] ?? ""}`,
                            children: product.availability
                          }
                        )
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-4 line-clamp-2", children: product.description }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5 mb-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-[11px]", children: product.category }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[11px]", children: product.season }),
                        (_a3 = product.tags) == null ? void 0 : _a3.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Badge,
                          {
                            variant: "outline",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground flex items-center gap-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3 h-3 shrink-0 text-primary" }),
                        product.sourcing
                      ] }),
                      product.minOrder && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-1", children: [
                        "Min. order:",
                        " ",
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: product.minOrder })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-primary font-medium mt-3 flex items-center gap-1", children: [
                        "View details ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Dialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "max-w-lg", "data-ocid": "products.dialog", children: selectedProduct && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-xl font-bold text-foreground leading-snug pr-6", children: selectedProduct.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `shrink-0 text-[11px] font-body font-medium px-2 py-0.5 rounded-full border ${availabilityColor[selectedProduct.availability] ?? ""}`,
                children: selectedProduct.availability
              }
            )
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 mt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: selectedProduct.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-lg p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground uppercase tracking-wider mb-1 flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-3 h-3" }),
                  " Season"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: selectedProduct.season })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-lg p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground uppercase tracking-wider mb-1 flex items-center gap-1.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: selectedProduct.minOrder ?? "Ask us" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-lg p-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground uppercase tracking-wider mb-1 flex items-center gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: selectedProduct.sourcing })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-[11px]", children: selectedProduct.category }),
              (_a2 = selectedProduct.tags) == null ? void 0 : _a2.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: "outline",
                  className: "text-[11px] text-accent border-accent/40",
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body uppercase tracking-widest text-primary font-semibold mb-3", children: "What We Offer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl font-bold text-foreground mb-4 text-balance", children: "End-to-End Service" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto", children: "From picking to delivery, every step is managed so you can focus on your customers." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: services.map((svc, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Card,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(svc.icon, { className: "w-5 h-5 text-primary" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-2", children: svc.title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-14 items-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body uppercase tracking-widest text-primary font-semibold mb-3", children: "Partner With Us" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl font-bold text-foreground mb-5 text-balance", children: "Ready to talk trade?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-8", children: "Whether you run a restaurant, manage a retail buying team, or operate a catering business — we'd love to understand your requirements and build a bespoke supply programme together." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-4 mb-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Address" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "123 Harvest Road, Springfield" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Phone" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "(555) 555-0178" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Email" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "info@freshvalleyproduce.com" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Business Hours" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Mon–Fri: 5:00 am – 4:00 pm" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Saturday: 5:00 am – 12:00 pm" })
                ] })
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "shadow-elevated border-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-7", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-lg mb-5", children: "Send an Enquiry" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "form",
              {
                className: "space-y-4",
